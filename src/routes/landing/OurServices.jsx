        ...
        return (
            <article className="section-3-container">
                ...
                <p className="pop-font section-description">
                    Pizza Ghar provides services across all states - various
                    foods and drinks, you choose! What makes us special is our
                    teams of professionals with extensive knowledge of all
                    cuisine that we have to offer.
                </p>
